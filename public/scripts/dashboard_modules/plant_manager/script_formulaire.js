document.addEventListener("DOMContentLoaded", function () {
  ...
  const sowingTableContainer = document.querySelector('.sowing-table-container');
...
function fetchDataAndPopulateTable() {
  ...
  fetch("https://walrus-app-jbfmz.ondigitalocean.app/vegetable_manager")
    ...
    .then((data) => {
      ...
      const filteredVegetables = data.filter((vegetable) => vegetable.sowed === true && vegetable.planted === false);
